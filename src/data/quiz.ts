...
export const QUESTIONS: Question[] = [
  {
    ...
    helper: "Elige la imagen que más te atraiga a primera vista.",
    options: [
      { text: "Neutros arena y maderas cálidas", image: u("photo-1618221195710-dd6b41faaea6"), weights: { contemporaneo: 2, escandinavo: 1 } },
      { text: "Blancos puros y grises suaves", image: u("photo-1567538096630-e0c55bd6374c"), weights: { minimalista: 2, escandinavo: 1 } },
      { text: "Terracota, ocre y madera con veta", image: u("photo-1583847268964-b28dc8f51f92"), weights: { calido: 2, clasico: 1 } },
      { text: "Negros, grises y tonos profundos", image: u("photo-1556228453-efd6c1ff04f6"), weights: { industrial: 2, clasico: 1 } },
    ],
  },
  {
    id: "espacio",
    ...
    options: [
      { text: "Abierto, luminoso y ordenado", image: u("photo-1524758631624-e2822e304c36"), weights: { minimalista: 2, contemporaneo: 1 } },
      { text: "Acogedor, con texturas y madera", image: u("photo-1493809842364-78817add7ffb"), weights: { calido: 2, escandinavo: 1 } },
      { text: "Amplio, con grandes ventanales", image: u("photo-1600210492486-724fe5c67fb0"), weights: { contemporaneo: 2, minimalista: 1 } },
      { text: "Con carácter y estructuras vistas", image: u("photo-1497366754035-f200968a6e72"), weights: { industrial: 2 } },
    ],
  },
  {
    id: "madera",
    prompt: "¿Qué acabado de madera te enamora?",
    helper: "Lo que distingue a The Woods.",
    options: [
      { text: "Roble claro mate, sereno", image: u("photo-1567016432779-094069958ea5"), weights: { escandinavo: 2, minimalista: 1 } },
      { text: "Nogal natural, cálido y vivo", image: u("photo-1616486338812-3dadae4b4ace"), weights: { contemporaneo: 2, calido: 1 } },
      { text: "Madera oscura, profunda y noble", image: u("photo-1600210491369-e753d80a41f3"), weights: { clasico: 2, industrial: 1 } },
      { text: "Madera recuperada con historia", image: u("photo-1449247709967-d4461a6a6103"), weights: { calido: 2, industrial: 1 } },
    ],
  },
  {
    id: "atmosfera",
    ...
    options: [
      { text: "Calma y equilibrio", image: u("photo-1505691938895-1758d7feb511"), weights: { minimalista: 2, escandinavo: 1 } },
      { text: "Energía y personalidad", image: u("photo-1497366811353-6870744d04b2"), weights: { industrial: 2, contemporaneo: 1 } },
      { text: "Calidez y confort", image: u("photo-1600566753086-00f18fb6b3ea"), weights: { calido: 2, escandinavo: 1 } },
      { text: "Sofisticación atemporal", image: u("photo-1616627561839-074385245ff6"), weights: { clasico: 2, contemporaneo: 1 } },
    ],
  },
  {
    id: "exterior",
    ...
    options: [
      { text: "Deck de madera con líneas rectas", image: u("photo-1600607687939-ce8a6c25118c"), weights: { contemporaneo: 2, minimalista: 1 } },
      { text: "Pérgola de madera y plantas", image: u("photo-1586023492125-27b2c045efd7"), weights: { escandinavo: 2, calido: 1 } },
      { text: "Madera rústica y asador", image: u("photo-1600585154340-be6161a56a0c"), weights: { calido: 2 } },
      { text: "Metal negro con madera oscura", image: u("photo-1502005229762-cf1b2da7c5d6"), weights: { industrial: 2, clasico: 1 } },
    ],
  },
];
